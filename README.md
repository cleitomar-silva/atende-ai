...
4. no chamado vinculado informar data e hora do vinculo.

5. no card Classificação possibilitar exibir o nome completo.

6. ao concluir o chamado o sistema informar qual foi o tempo de SLA que foi utilizado

7. informar que é nota interna no comentário. colocar 'Nota Interna:' e na sequencia o comentario.

8. usuario do setor demandado consegue ver a nota interna do usuario solicitante, mesmo sendo de setor difente. e vice versa. nao permitir.
